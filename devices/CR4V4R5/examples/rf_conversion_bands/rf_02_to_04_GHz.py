...
cr4.tune_filters(channels=[1,2,3,4], lpf_switch=0, lpf_band=0, hpf_switch=0, hpf_band=0)
...
cr4.tune_pll("D", 12000)
cr4.tune_pll("B", 12000)

# Tune the upconvert PLLs in MHz
cr4.tune_pll("A", 12000)
cr4.tune_pll("C", 12000)